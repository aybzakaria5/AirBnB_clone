...
#-------------------------------------------------------------------
 ...
 #-----------------------------------------------------------------
    ...
    def test_destroy_BaseModel_instance_found_saves_change(self):
        ...
        # Deletes an instance when given a valid class name and id with numbers.
    def test_destroy_valid_class_name_and_id_with_numbers(self):
        '''
        Test that do_destroy deletes an instance when given a valid class name and id with numbers
        '''     
        with patch("sys.stdout", new=StringIO()) as f:
            HBNBCommand().onecmd("create BaseModel")
            obj_id = f.getvalue().strip()
        ...
        # Deletes an instance when given a valid class name and id with special characters.
    def test_destroy_valid_class_name_and_id_with_special_characters(self):
        '''
        Test that do_destroy deletes an instance when given a valid class name and id with special characters
        '''
        storage = FileStorage()
        storage.reload()
        with patch("sys.stdout", new=StringIO()) as f:
