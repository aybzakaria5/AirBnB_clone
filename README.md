...
## Requeriments 📋
---
Airbnb was built and tested in Ubuntu 22.04 LTS  (vagrent) => Programming language python3

## Installation and execution 🔧
---
* Clone the repository
> $ git clone https://github.com/Lelaabk/AirBnB_clone.git
...
```
daz5@DESKTOP-6PPFSAT:~/H/AirBnB_clone$ ./console.py 
(hbnb) all
[]
(hbnb) create Place
...
0
(hbnb) quit
daz5@DESKTOP-6PPFSAT:~/H/AirBnB_clone$
```

### Non - Interactive Mode ⌨️
```
daz5@DESKTOP-6PPFSAT:~/H/AirBnB_clone$ echo "create User" | ./console.py
(hbnb) 55b76419-6009-4b36-b88a-7c2930283f4a
daz5@DESKTOP-6PPFSAT:~/H/AirBnB_clone$ echo "show User 55b76419-6009-4b36-b88a-7c2930283f4a" | ./console.py
...
* [AYOUB ZAKARIA](https://github.com/aybzakaria5)  - LinkedIn profile (https://www.linkedin.com/in/ayb-zakarya/)
* [LAYLA ABKARI](https://github.com/Lelaabk) -  LinkedIn profile (https://www.linkedin.com/in/layla-abkari-5505301a3/)
